...
if ((${CMAKE_INSTALL_PREFIX} STREQUAL /usr/local) OR
    ...
    set(CMAKE_INSTALL_PREFIX ${BASE_DIR}/output CACHE STRING "path for install()" FORCE)
    message(STATUS "No install prefix selected, default to ${CMAKE_INSTALL_PREFIX}.")
endif()

if (ACL_PB_PKG)
    set(REQ_URL "${ACL_PB_PKG}/libs/ge_gtest/release-1.8.1.tar.gz")
    set(MD5 "")
elseif (ENABLE_GITEE)
...
ExternalProject_Add(gtest_build
                ...
                -DBUILD_TESTING=OFF -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DBUILD_SHARED_LIBS=ON -DCMAKE_MACOSX_RPATH=TRUE -Dgtest_disable_pthreads=OFF
                    BUILD_COMMAND $(MAKE)
